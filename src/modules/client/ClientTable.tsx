...
export function ClientTable({ data, sorting, onSortingChange, onEdit, onDelete }: Props) {
  ...
  const columns: ColumnDef<ClientType>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <TableActions>
            <TableActionEdit onClick={() => onEdit(client)} />

            <TableActionDelete
              title="Excluir Cliente"
              description={`Deseja excluir o cliente ${client.personName}?`}
